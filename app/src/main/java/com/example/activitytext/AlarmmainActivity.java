                ...
                dialog=new TimePickerDialog(
                        ...
                        new TimePickerDialog.OnTimeSetListener(){
                            public void onTimeSet(TimePicker timePicker, int hourOfDay,int minute) {
                                ...
                                Intent intent = new Intent(AlarmmainActivity.this, AlarmReceiver.class);    //创建Intent对象
                                PendingIntent pi = PendingIntent.getBroadcast(AlarmmainActivity.this, 0, intent, 0);    //创建PendingIntent
                                ...
                                Toast.makeText(AlarmmainActivity.this, "闹钟设置成功", Toast.LENGTH_LONG).show();//提示用户
                            }
                        },
